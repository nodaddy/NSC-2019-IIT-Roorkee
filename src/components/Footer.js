...
export default class Footer extends Component{
    render(){
        return (
          ...
          <Grid sm={12}>
            <h3 style={{color:'navy'}}>Contacts</h3>
            </Grid>
        <Grid sm={4} align="center">

            <b style={{color:'darkred',fontSize:16}}>Prof. S.P. Harsha</b><br/>
        ...
        Email: surajfme@iitr.ac.in
            ...
            <Grid sm={4} align="center">
                   ...
                   <b style={{color:'darkred',fontSize:16}}>Prof. V. Huzur Saran</b><br/>
        ...
        <Grid sm={4} align="center">
                                                   ...
                                                   <b style={{color:'darkred',fontSize:16}}>Prof. Avinash Parashar</b><br/>
       Joint Secretary, NSC 2019<br/>
        Department of Mechanical &amp; Industrial Engineering<br/>
        IIT Roorkee, Roorkee-247667<br/>
